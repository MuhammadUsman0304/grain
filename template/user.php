                ...
                <a class="dropdown-item preview-item" href="pages/samples/adddata.php?user=<?php echo $id; ?>">
                  ...
                  <div class="preview-item-content">
                    <p class="preview-subject mb-1">Add Data</p>
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item preview-item" href="pages/samples/addmainpro.php?user=<?php echo $id; ?>">
                                    <div class="preview-thumbnail">
                                        <div class="preview-icon bg-dark rounded-circle">
                                            <i class="mdi mdi-cube text-primary"></i>
                                        </div>
                                    ...
                                    <div class="preview-item-content">
                                        <p class="preview-subject mb-1">Add Product</p>
                                    </div>
                                </a>
                                <!-- <div class="dropdown-divider"></div>
                ...
                <div class="content-wrapper" style="height: 400px;overflow-x: scroll;">
                    ...
                    <table class="table table-bordered table-dark">
                        ...
                        <tbody>
                            ...
                            $runuser = mysqli_query($con, $userquery);
                            $count = mysqli_num_rows($runuser);
                            $slnumber = 0;

                            // printing data

                            while ($fetchdata = mysqli_fetch_array($runuser)) {
                                $slnumber++;
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $fetchdata['proImg']; ?></td>
                                    <td><?php echo $fetchdata['Email']; ?></td>
                                    <td><?php echo $fetchdata['Pass']; ?></td>
                                    <td><?php echo $fetchdata['ActionRole']; ?></td>
                                    <td><a href="pages/samples/user_edit.php?id=<?php echo $fetchdata['id'] ?>&user=<?php echo $id; ?>"><i class="mdi mdi-square-edit-outline"></i></a></td>
                                    <td><a onclick="aleart()" href="pages/samples/user_delete.php?id=<?php echo $fetchdata['id'] ?>&user=<?php echo $id; ?>"><i class="mdi mdi-delete"></i></a></td>
