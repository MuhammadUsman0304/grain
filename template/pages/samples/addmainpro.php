            ...
            <div class="row w-100 m-0">
              ...
              ';
                        ...
                        <div class="card-body px-5 py-5">
                            ...
                            <form action="addpro_core.php" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input require type="text" name="des" placeholder="Description" class="form-control p_input">
                                </div>
